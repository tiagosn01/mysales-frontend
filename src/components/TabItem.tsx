...
export function TabItem({ title, value, isSelected }: TabItemProps) {
  return (
    <Tabs.Trigger
      value={value}
      className="marker:group  relative  px-1 pb-4 text-sm font-medium leading-5 text-zinc-500  outline-none data-[state=active]:text-violet-700 hover:text-violet-700 dark:text-zinc-400 dark:data-[state=active]:text-zinc-100 dark:hover:text-zinc-100"
    >
